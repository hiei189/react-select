...
var instructionsAriaMessage = function instructionsAriaMessage(event) {
  ...
  switch (event) {
    case 'menu':
      return "Utiliza flecha arriba y flecha abajo para seleccionar una opci\xF3n".concat(isDisabled ? '' : ', presiona enter para seleccionar la opción en foco', ", presiona Escape para salir del men\xFA, presiona Tab para seleccionar la opci\xF3n y salir del men\xFA.");

    case 'input':
      return "".concat(label ? label : 'Select', " est\xE1 seleccionado ").concat(isSearchable ? ', escribe para mejorar la lista' : '', ", presiona flecha abajo para abrir el men\xFA, ").concat(isMulti ? ' presiona flecha a la izquierda para dar foco a las opciones seleccionadas' : '');
...
var valueEventAriaMessage = function valueEventAriaMessage(event, context) {
  ...
  switch (event) {
    ...
    case 'pop-value':
    case 'remove-value':
      return "Opci\xF3n ".concat(value, ", deseleccionada.");
